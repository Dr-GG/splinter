...
namespace Splinter.NanoInstances.Default.Tests.Agents.Knowledge
{
    ...
    public abstract class LanguageAgents : NanoAgent, ILanguageAgent
    {
    ...
    public class AfrikaansLanguageAgent : LanguageAgents
    {
    ...
    public class EnglishLanguageAgent : LanguageAgents
    {
    ...
    public class FrenchLanguageAgent : LanguageAgents
    {
    ...
    public class GermanLanguageAgent : LanguageAgents
    {
    ...
    public class SpanishLanguageAgent : LanguageAgents
    {
